...
val make_graph_addon: ?color:'a -> 'a -> string -> unit

val make_graph_addon_no_newline: ?color:'a -> 'a -> string -> unit
...
val make_final_judgement_graph_addon: ?color:'a -> 'a -> string -> unit

val type_word: 'a -> 'b

val make_graph_scenario: string -> string list -> unit

val type_out_string: 'a -> string
